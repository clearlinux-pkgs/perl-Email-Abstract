...
%prep
%setup -q -n Email-Abstract-3.009
cd %{_builddir}
tar xf %{_sourcedir}/libemail-abstract-perl_3.008-1.debian.tar.xz
cd %{_builddir}/Email-Abstract-3.009
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Email-Abstract-3.009/deblicense/
...
cp %{_builddir}/Email-Abstract-3.009/LICENSE %{buildroot}/usr/share/package-licenses/perl-Email-Abstract/f64962ea2646981898a121d94ec42de3a591f049
